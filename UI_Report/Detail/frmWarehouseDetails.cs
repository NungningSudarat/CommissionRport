...
namespace CommissionRport.Ul_Details
{
	public partial class frmWarehouseDetails : Form
	{
		...
		public frmWarehouseDetails(cBeauty cBeauty, int BID, ref ArrayList menuList)
		{
			InitializeComponent();
			_cBeauty = cBeauty;
			_menuList = menuList;
		...
		private void frmWarehouseDetails_Load(object sender, EventArgs e)
		{
		...
		private void SaveData()
		{
			...
			string sql = @"EXEC COMMISSION_WHCODE '" + DOCNO + "' , '" + _BID + "'";
