...
{
	partial class frmNumDay_ImportDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmNumDay_ImportDialog));
			...
			this.lsvData.TabIndex = 207;
			this.lsvData.UseCompatibleStateImageBehavior = false;
			this.lsvData.View = System.Windows.Forms.View.Details;
			// 
			// frmcomonline_numDay_ImportDialog
			// 
			...
			this.Name = "frmcomonline_numDay_ImportDialog";
			this.Text = "frmcomonline_numDay_ImportDialog";
			this.Load += new System.EventHandler(this.frmcomonline_numDay_ImportDialog_Load);
