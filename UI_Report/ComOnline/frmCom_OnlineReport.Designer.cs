...
{
	partial class frmCom_OnlineReport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCom_OnlineReport));
			this.toolStrip2 = new System.Windows.Forms.ToolStrip();
			this.btnSave = new System.Windows.Forms.ToolStripButton();
			this.btnExport_import = new System.Windows.Forms.ToolStripSplitButton();
			this.tAGETToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			// btnExport_import
			// 
			this.btnExport_import.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.tAGETToolStripMenuItem,
            this.จำนวนวนพนกงานทำงานToolStripMenuItem});
			this.btnExport_import.Image = ((System.Drawing.Image)(resources.GetObject("btnExport_import.Image")));
			this.btnExport_import.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnExport_import.Name = "btnExport_import";
			this.btnExport_import.Size = new System.Drawing.Size(181, 36);
			this.btnExport_import.Text = "นำเข้าข้อมูล(*.CSV)";
			this.btnExport_import.ToolTipText = "นำเข้าข้อมูล";
			this.btnExport_import.Visible = false;
			// 
			// tAGETToolStripMenuItem
			// 
			this.tAGETToolStripMenuItem.Name = "tAGETToolStripMenuItem";
			this.tAGETToolStripMenuItem.Size = new System.Drawing.Size(242, 24);
			this.tAGETToolStripMenuItem.Text = "TAGET";
			this.tAGETToolStripMenuItem.Click += new System.EventHandler(this.tAGETToolStripMenuItem_Click_1);
			// 
			...
			this.btnExport_export.Click += new System.EventHandler(this.btnExport_export_Click_1);
			// 
			// toolStripSeparator3
			// 
			...
			this.btnComOnilne.Size = new System.Drawing.Size(129, 31);
			this.btnComOnilne.TabIndex = 300;
			this.btnComOnilne.Text = "คำนวณ ComOnilne";
			...
			this.cmbDOCNO.ChangeUICues += new System.Windows.Forms.UICuesEventHandler(this.cmbDOCNO_ChangeUICues);
			// 
			// bntSave
			// 
			...
			this.Name = "frmCom_OnlineReport";
			this.Text = "frmCom_OnlineReport";
			this.Load += new System.EventHandler(this.frmCom_OnlineReport_Load);
		...
		private System.Windows.Forms.ToolStripSplitButton btnExport_import;
		private System.Windows.Forms.ToolStripMenuItem tAGETToolStripMenuItem;
