...
{
	partial class frmTaget_Online_ImportDialog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmTaget_Online_ImportDialog));
			...
			this.lsvData.TabIndex = 206;
			this.lsvData.UseCompatibleStateImageBehavior = false;
			this.lsvData.View = System.Windows.Forms.View.Details;
			// 
			// frmcomonline_Taget_ImportDialog
			// 
			...
			this.Name = "frmcomonline_Taget_ImportDialog";
			this.Text = "frmcomonline_Taget_ImportDialog";
			this.Load += new System.EventHandler(this.frmcomonline_Taget_ImportDialog_Load);
